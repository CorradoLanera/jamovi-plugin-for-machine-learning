...
experimenterOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "experimenterOptions",
...
experimenterResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "experimenterResults",
...
experimenterBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "experimenterBase",
